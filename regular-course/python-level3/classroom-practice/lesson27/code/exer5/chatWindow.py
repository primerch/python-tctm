...
class ChatWindow(QWidget):
    ...
    def setUi(self):
        ...
        # 1. 添加视频聊天按钮videoBtn属性，设置固定大小为30*24

        # 2. 设置videoBtn的样式为无边框

        # 3. 设置videoBtn的图标大小为30*40，路径为../images/video.png

        # 4. 设置videoBtn的位置坐标为750,460，并隐藏

        # 6. 给videoBtn绑定点击事件的处理函数videoChat

    # 5. 定义点击事件处理函数videoChat，输出："进入视频聊天..."
