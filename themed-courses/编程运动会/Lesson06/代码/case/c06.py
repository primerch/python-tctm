...
def playerAnim():
    ...
    if plyState == 'idle':
        if plyTurn == 'left':
            plyFrm, plyC = Anim(plyIL, plyFrm, plyC, x=x, y=y)
        else:
            plyFrm, plyC = Anim(plyIR, plyFrm, plyC, x=x, y=y)
    elif plyState == 'moving':
        if plyTurn == 'left':
            plyFrm, plyC = Anim(plyML, plyFrm, plyC, x=x, y=y)
        else:
            plyFrm, plyC = Anim(plyMR, plyFrm, plyC, x=x, y=y)
    elif plyState == 'attack':
        if plyTurn == 'left':
            plyFrm, plyC = Anim(plyAL, plyFrm, plyC, x=x, y=y)
        else:
            plyFrm, plyC = Anim(plyAR, plyFrm, plyC, x=x, y=y)
