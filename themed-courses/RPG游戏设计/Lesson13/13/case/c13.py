...
def changeBar(s):
    ...
    if s == pet:
        petHP.image = pygame.transform.scale(petHP.image,(142*ratioHP,16))
        petMP.image = pygame.transform.scale(petMP.image,(142*ratioMP,16))
    elif s == enemy:
        enemyHP.image = pygame.transform.scale(enemyHP.image, (142 * ratioHP, 16))
        enemyMP.image = pygame.transform.scale(enemyMP.image, (142 * ratioMP, 16))
